...
contract QuoterV2 is IQuoterV2, IUniswapV3SwapCallback, PeripheryImmutableState, BlastConfigure {
    ...
    constructor(address _factory, address _WETH9, address _blast, address _blastPoints) 
