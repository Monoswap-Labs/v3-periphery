...
library NFTSVG {
    ...
    function generateSVGDefs(
        ...
        svg = string(
            abi.encodePacked(
                ...
                '<rect x="0" y="0" width="290" height="500" rx="42" ry="42" fill="rgba(0,0,0,0)" stroke="url(#grad-text)" /></g>'
            )
        );
    }
    ...
    function generateSVGBorderText(
        ...
        svg = string(
            abi.encodePacked(
                ...
                '<textPath startOffset="-100%" fill="url(#grad-text)" font-family="\'Courier New\', monospace" font-size="10px" xlink:href="#text-path-a">',
                baseToken,
                unicode" • ",
                baseTokenSymbol,
                ' <animate additive="sum" attributeName="startOffset" from="0%" to="100%" begin="0s" dur="30s" repeatCount="indefinite" />',
                '</textPath> <textPath startOffset="0%" fill="url(#grad-text)" font-family="\'Courier New\', monospace" font-size="10px" xlink:href="#text-path-a">',
                baseToken,
                unicode" • ",
                baseTokenSymbol,
                ' <animate additive="sum" attributeName="startOffset" from="0%" to="100%" begin="0s" dur="30s" repeatCount="indefinite" /> </textPath>',
                '<textPath startOffset="50%" fill="url(#grad-text)" font-family="\'Courier New\', monospace" font-size="10px" xlink:href="#text-path-a">',
                quoteToken,
                unicode" • ",
                quoteTokenSymbol,
                ' <animate additive="sum" attributeName="startOffset" from="0%" to="100%" begin="0s" dur="30s"',
                ' repeatCount="indefinite" /></textPath><textPath startOffset="-50%" fill="url(#grad-text)" font-family="\'Courier New\', monospace" font-size="10px" xlink:href="#text-path-a">',
                quoteToken,
                unicode" • ",
                quoteTokenSymbol,
    ...
    function generateSVGCardMantle(
        ...
        svg = string(
            abi.encodePacked(
                '<g mask="url(#fade-symbol)"><rect fill="none" x="0px" y="0px" width="290px" height="200px" /> <text y="50px" x="32px" fill="url(#grad-text)" font-family="\'Courier New\', monospace" font-weight="200" font-size="36px">MONOSWAP</text> <text y="90px" x="32px" fill="url(#grad-text)" font-family="\'Courier New\', monospace" font-weight="200" font-size="36px">',
                quoteTokenSymbol,
                "/",
                baseTokenSymbol,
                '</text><text y="130px" x="32px" fill="url(#grad-text)" font-family="\'Courier New\', monospace" font-weight="200" font-size="36px">',
                feeTier,
                "</text></g>",
    ...
    function generageSvgCurve(
        ...
        svg = string(
            abi.encodePacked(
                ...
                '<path d="',
                curve,
                '" stroke="url(#grad-text)" fill="none" stroke-linecap="round" /></g>',
    ...
    function generateSVGPositionDataAndLocationCurve(
        ...
        svg = string(
            abi.encodePacked(
                ...
                '<text x="12px" y="17px" font-family="\'Courier New\', monospace" font-size="12px" fill="url(#grad-text)"><tspan fill="url(#grad-text)">ID: </tspan>',
                tokenId,
                "</text></g>",
                ...
                'px" height="26px" rx="8px" ry="8px" fill="rgba(0,0,0,0.6)" />',
                '<text x="12px" y="17px" font-family="\'Courier New\', monospace" font-size="12px" fill="url(#grad-text)"><tspan fill="url(#grad-text)">Min Tick: </tspan>',
                tickLowerStr,
                "</text></g>",
                ...
                'px" height="26px" rx="8px" ry="8px" fill="rgba(0,0,0,0.6)" />',
                '<text x="12px" y="17px" font-family="\'Courier New\', monospace" font-size="12px" fill="url(#grad-text)"><tspan fill="url(#grad-text)">Max Tick: </tspan>',
                tickUpperStr,
                "</text></g>"
                '<g style="transform:translate(226px, 433px)">',
                '<rect width="36px" height="36px" rx="8px" ry="8px" fill="none" stroke="url(#grad-text)" />',
                '<path stroke-linecap="round" d="M8 9C8.00004 22.9494 16.2099 28 27 28" fill="none" stroke="url(#grad-text)" />',
                '<circle style="transform:translate3d(',
                xCoord,
                "px, ",
                yCoord,
                'px, 0px)" cx="0px" cy="0px" r="4px" fill="url(#grad-text)"/></g>'
            )
        );
    }
    ...
    function generateSVGRareSparkle(
        ...
        if (isRare(tokenId, poolAddress)) {
            svg = string(
                abi.encodePacked(
                    '<g style="transform:translate(226px, 392px)"><rect width="36px" height="36px" rx="8px" ry="8px" fill="none" stroke="url(#grad-text)" />',
                    ...
                    '23L10.2181 13.7819L1.6077 18L9.56587 12.6522L0 12L9.56587 11.3478L1.6077 6L10.2181 10.2181L6 1.6077L11.3478 9.56587L12 0Z" fill="url(#grad-text)" />',
